...
export const createContactItem = () => {
  ...
  contactDelete.addEventListener('click', (e) => {
    e.preventDefault();
    contact.remove();
    document.querySelector('.modal__btn-contact').classList.add('modal__btn-contact_active');
  })

  contactName.addEventListener('click', (e) => {
    e.preventDefault();
    contactList.classList.toggle('contact__list_active');
    contactName.classList.toggle('contact__list_active');
  })

  contactType.addEventListener('mouseleave', () => {
    contactList.classList.remove('contact__list_active');
    contactName.classList.remove('contact__list_active');
  })
